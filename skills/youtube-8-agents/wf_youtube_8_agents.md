...
# AWF_METADATA_START
type: workflow
name: "youtube_8_agents"
command: "/youtube-8-agents"
awf_version: "4.0.0"
...
- `youtube-8-agents` (required): Tuân thủ skill một cách tuyệt đối. Không được bỏ qua bước Chief Synthesis and QA Agent.
