...
Em sẽ dẫn Sếp qua 8 bước để ra bài sắc, đúng target, và không bịa proof.
...
### BƯỚC 7.5 — Proof & Claim Audit (BẮT BUỘC)

Trước khi xuất dàn ý hoặc full content, AI phải rà toàn bộ claim sẽ dùng:

```
PROOF AUDIT:
✅ User đã cung cấp: [số liệu / testimonial / case study / deadline / giá / slot / authority]
⚠️ Chưa có bằng chứng: [claim cần giữ dạng giả định hoặc placeholder]
❌ Không được dùng như fact: [mọi con số/tên người/kết quả/deadline chưa xác nhận]
```

**Quy tắc xử lý:**
- Nếu thiếu proof nhưng không ảnh hưởng logic bài → dùng placeholder rõ ràng: `[SỐ LIỆU THẬT]`, `[CASE STUDY THẬT]`, `[DEADLINE THẬT]`.
- Nếu thiếu proof làm bài dễ gây hiểu lầm → hỏi Sếp 1 câu ngắn để xác nhận.
- Không bao giờ tự điền tên khách hàng, phần trăm tăng trưởng, doanh thu, số slot, countdown, media logo, hoặc nghiên cứu.
