...
| `harness/` | Reusable intake, story, decision, and proof artifacts adapted from `harness-experimental` |
...
- Large or risky feature work passes through harness intake before code.
- Important factual or persuasive claims go through the global truthfulness gate.
- Implemented claims are backed by story packets and proof matrix evidence.
